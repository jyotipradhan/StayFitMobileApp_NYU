...
if ( !in_array( $action, array( 'login','walking','laughing','notify','breathing','preset', 'logout', 'signup', 'sendPassword','stretching', 'newTodo', 'editTodo', 'deleteTodo', 'changeTodoStatus', 'options', 'deleteCompleted', 'changePassword','activity','help','excercise' ), true ) ) $action = 'listExercise';
$action();
...
function walking() {
  require( TEMPLATE_PATH . "/walking.php" );
}


function laughing() {
  require( TEMPLATE_PATH . "/laughing.php" );
}

function notify(){
require( TEMPLATE_PATH . "/notification.php" );
...
function breathing() {
  require( TEMPLATE_PATH . "/exeBreathe.php" );
}
